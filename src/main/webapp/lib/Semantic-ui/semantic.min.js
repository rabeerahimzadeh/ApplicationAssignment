        ...
        return r.each(function () {
            ...
            f = {
                initialize: function () {
                    ...
                    return f.is.enabled() ? void f.debug("Checkbox is already enabled") : (f.debug("Enabling checkbox"), f.set.enabled(), void g.onEnable.call(S))
                }, disable: function () {
                    return f.is.disabled() ? void f.debug("Checkbox is already disabled") : (f.debug("Disabling checkbox"), f.set.disabled(), void g.onDisable.call(S))
                }, get: {
                    radios: function () {
                        var t = f.get.name();
        ...
        return e(this).each(function () {
            ...
            f = {
                initialize: function () {
                    ...
                    return i || o ? (g.maxResults > 0 && (i ? "standard" == g.type && f.error(x.maxResults) : t[b.results] = t[b.results].slice(0, g.maxResults)), e.isFunction(n) ? a = n(t, b) : f.error(x.noTemplate, !1)) : a = f.displayMessage(x.noResults, "empty"), g.onResults.call(E, t), a
                ...
                initialize: function () {
                    ...
                    lastScroll: function (e) {
                        ...
                        var e = {height: k.height()}, t = {
                            margin: {
                                top: parseInt(C.css("margin-top"), 10), bottom: parseInt(C.css("margin-bottom"), 10)
            ...
            v = {
                initialize: function () {
                    ...
                    request: function () {
                        ...
                        return i = e.Deferred().always(v.event.xhr.complete).done(v.event.xhr.done).fail(v.event.xhr.fail), h.mockResponse ? (e.isFunction(h.mockResponse) ? (v.debug("Using mocked callback returning response", h.mockResponse), n = h.mockResponse.call(P, h)) : (v.debug("Using specified response", h.mockResponse), n = h.mockResponse), i.resolveWith(P, [n, o, {responseText: n}])) : e.isFunction(h.mockResponseAsync) && (t = function (e) {
                            v.debug("Async callback returned response", e), e ? i.resolveWith(P, [e, o, {responseText: e}]) : i.rejectWith(P, [{responseText: e}, a, r])
                        }, v.debug("Using async mocked response", h.mockResponseAsync), h.mockResponseAsync.call(P, h, t)), i
                    }, xhr: function () {
                        var t;
            ...
            g = {
                initialize: function () {
                    ...
                    calculations: function () {
                        ...
                        return e = t > n && n ? "down" : n > t && n ? "up" : "static", g.cache.direction = e,
                            g.cache.direction
